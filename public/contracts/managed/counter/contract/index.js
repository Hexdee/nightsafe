...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.privateLimit) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named privateLimit');
    }
    ...
    this.circuits = {
      increment: (...args_1) => {
        ...
        const result_0 = this._increment_0(context, partialProofData, delta_0);
  ...
  _privateLimit_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.privateLimit(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('privateLimit',
                                 'return value',
  ...
  _increment_0(context, partialProofData, delta_0) {
    const limit_0 = this._privateLimit_0(context, partialProofData);
    __compactRuntime.assert(delta_0 > 0n, 'delta must be greater than zero');
    __compactRuntime.assert(delta_0 <= limit_0,
                            'delta exceeds the private limit');
    const tmp_0 = ((t1) => {
                    if (t1 > 18446744073709551615n) {
                      throw new __compactRuntime.CompactError('counter.compact line 24 char 22: cast from Field or Uint value to smaller Uint value failed: ' + t1 + ' is greater than 18446744073709551615');
                    }
                    return t1;
...
const _dummyContract = new Contract({ privateLimit: (...args) => undefined });
